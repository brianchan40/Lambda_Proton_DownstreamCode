...
/// PicoDst headers
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoDstReader.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoDst.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoEvent.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoTrack.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoBTofHit.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoBTowHit.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoEmcTrigger.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoBTofPidTraits.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StPicoEvent/StPicoTrackCovMatrix.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StEpdUtil/StEpdEpFinder.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StRefMultCorr/StRefMultCorr.h"
#include "/star/data01/pwg/zhiwanxu/ESE-code/StRoot/StRefMultCorr/CentralityMaker.h"
...
const int opt_sys = 0;
const int opt_HighOrder = 0;//not 2
const int opt_useEPD = 0;  //0 is TPC EP, 1 is EPD, 11 is 1st-order EPD, 2 is BBC, 3 is ZDC
...
const float EtaCut_asso = 0.9999;
...
const float EtaCut_trig = 0.9999;
...
const float v2_averaged[9] = {0.0501232,0.0534059,0.0560419,0.0574026,0.0553413,0.0489581,0.0374727,0.0255116,0.0153378};//This is mean TPC averaged
const float v2_parent_averaged[9]={0.0423775,0.0432856,0.0455796,0.046612,0.0448772,0.0396457,0.0301542,0.0208154,0.0126224};//0.0519724,0.0530172,0.0555029,0.0566307,0.0544259,0.0480262,0.036507,0.0252063,0.0152261};//This is parent v2
//bad runs
...
//new efficiency
const float PP0[9] = {8.71218e-01,8.72933e-01,8.68838e-01,8.66543e-01,8.60677e-01,8.56335e-01,8.50640e-01,8.41993e-01,8.34163e-01};// {8.75317e-01,8.73691e-01,8.69273e-01,8.66705e-01,8.61336e-01,8.48794e-01,8.33457e-01,8.16553e-01,8.01148e-01};
const float PP1[9] = {1.23429e-01,1.23299e-01,1.22216e-01,1.21815e-01,1.24344e-01,1.26645e-01,1.27493e-01,1.28687e-01,1.30046e-01};//{1.29625e-01,1.29080e-01,1.31148e-01,1.30600e-01,1.31081e-01,1.33922e-01,1.34175e-01,1.34916e-01,1.35806e-01};
const float PP2[9] = {3.79632e+00,3.75484e+00,4.02690e+00,3.60593e+00,3.72778e+00,3.82028e+00,3.70317e+00,3.57753e+00,3.61064e+00};//{6.88369e+00,8.00026e+00,6.25220e+00,7.18563e+00,7.06380e+00,6.77852e+00,6.91458e+00,6.74690e+00,7.10116e+00};
...
//defining histograms
	struct WeightHists {
        ...
        TProfile *pTemp_track = new TProfile("pTemp_track","pTemp_track",5,0.5,5.5,-10,10); //pT, eta,phi,charge,DCA,
	...
	TProfile *v2_TPC_Day3  = new TProfile("v2_TPC_Day3","v2_TPC_Day3",run_end-run_sta,run_sta,run_end,-100,100);
        ...
        TProfile *v2_EPD1_Day3  = new TProfile("v2_EPD1_Day3","v2_EPD1_Day3",run_end-run_sta,run_sta,run_end,-100,100);
	...
	TH1D *Hist_FMRatio = new TH1D("Hist_FMRatio","track splitting ratio",100,0,1);
	...
	TH1D* Hist_parentv2 = new TH1D("Hist_parentv2","Hist_parentv2",200,-100,100);
	...
	TProfile *Hist_v2parent_eta_obs6 = new TProfile("Hist_v2parent_eta_obs6","v2 parent ESE POI cut TPC",100,-5,5,-100,100,"");
	TProfile *Hist_v2parent_eta_obs9 = new TProfile("Hist_v2parent_eta_obs9","v2 parent TPC noHBT",100,-5,5,-100,100,"");
	TProfile *Hist_v2parent_eta_obs10 = new TProfile("Hist_v2parent_eta_obs10","v2 parent ESE POI cut TPC noHBT",100,-5,5,-100,100,"");
        TProfile *Hist_v2parent_pt_obs5 = new TProfile("Hist_v2parent_pt_obs5","v2 parent TPC",50,0,5,-100,100,"");
        TProfile *Hist_v2parent_pt_obs6 = new TProfile("Hist_v2parent_pt_obs6","v2 parent ESE POI cut TPC",50,0,5,-100,100,"");
//        TProfile *Hist_v2parent_pt_obs9 = new TProfile("Hist_v2parent_pt_obs9","v2 parent TPC noHBT",60,-1.5,1.5,-100,100,"");
//        TProfile *Hist_v2parent_pt_obs10 = new TProfile("Hist_v2parent_pt_obs10","v2 parent ESE POI cut TPC noHBT",60,-1.5,1.5,-100,100,"");
	...
	TProfile *Hist_v2_pt_EPD_obs = new TProfile("Hist_v2_pt_EPD_obs","Hist_v2_pt_EPD_obs",300,0,15,-100,100,"");
        ...
        TH1D* Hist_InvMass_OS = new TH1D("Hist_InvMass_OS","Hist_InvMass_OS",800,0,4);
        TH1D* Hist_InvMass_SS = new TH1D("Hist_InvMass_SS","Hist_InvMass_SS",800,0,4);
        TProfile *pParity_InvMass_OS = new TProfile("pParity_InvMass_OS","pParity_InvMass_OS",800,0,4,-100,100);
        TProfile *pParity_InvMass_SS = new TProfile("pParity_InvMass_SS","pParity_InvMass_SS",800,0,4,-100,100);
        ...
        TProfile *pTemp_v2_parent = new TProfile("pTemp_v2_parent","pTemp_v2_parent",6,0.5,6.5,-100,100,"");
	...
	TProfile2D *pDelta_Q2_obs1 = new TProfile2D("pDelta_Q2_obs1","pDelta_Q2_obs1",4,0.5,4.5,250, 0, 25, -100,100,"");
        ...
        TH1D* Hist_Q2_parent = new TH1D("Hist_Q2_parent","Q2 parent",500,0,50);
        TH2D* Hist_RefMult_Q2_parent = new TH2D("Hist_RefMult_Q2_parent","Hist_RefMult_Q2_parent",500,0,50,500,0,500);
        ...
        TProfile2D *pParity_e_Q2parent_obs1 = new TProfile2D("pParity_e_Q2parent_obs1","pParity_e_Q2parent_obs1",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pParity_e_Q2parent_obs2 = new TProfile2D("pParity_e_Q2parent_obs2","pParity_e_Q2parent_obs2",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pParity_w_Q2parent_obs1 = new TProfile2D("pParity_w_Q2parent_obs1","pParity_w_Q2parent_obs1",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pParity_w_Q2parent_obs2 = new TProfile2D("pParity_w_Q2parent_obs2","pParity_w_Q2parent_obs2",4,0.5,4.5,500,0,50, -100,100,"");
        ...
        TProfile *p_v2e_noHBT_Q2_P_obs1 = new TProfile("p_v2e_noHBT_Q2_P_obs1","p_v2e_noHBT_Q2_P_obs1",500,0,50,-100,100,"");
        TProfile *p_v2e_noHBT_Q2_P_obs2 = new TProfile("p_v2e_noHBT_Q2_P_obs2","p_v2e_noHBT_Q2_P_obs2",500,0,50,-100,100,"");
        TProfile *p_v2w_noHBT_Q2_P_obs1 = new TProfile("p_v2w_noHBT_Q2_P_obs1","p_v2w_noHBT_Q2_P_obs1",500,0,50,-100,100,"");
        TProfile *p_v2w_noHBT_Q2_P_obs2 = new TProfile("p_v2w_noHBT_Q2_P_obs2","p_v2w_noHBT_Q2_P_obs2",500,0,50,-100,100,"");
        TProfile *p_v2e_noHBT_Q2_N_obs1 = new TProfile("p_v2e_noHBT_Q2_N_obs1","p_v2e_noHBT_Q2_N_obs1",500,0,50,-100,100,"");
        TProfile *p_v2e_noHBT_Q2_N_obs2 = new TProfile("p_v2e_noHBT_Q2_N_obs2","p_v2e_noHBT_Q2_N_obs2",500,0,50,-100,100,"");
        TProfile *p_v2w_noHBT_Q2_N_obs1 = new TProfile("p_v2w_noHBT_Q2_N_obs1","p_v2w_noHBT_Q2_N_obs1",500,0,50,-100,100,"");
        TProfile *p_v2w_noHBT_Q2_N_obs2 = new TProfile("p_v2w_noHBT_Q2_N_obs2","p_v2w_noHBT_Q2_N_obs2",500,0,50,-100,100,"");
        TProfile2D *pParity_e_noHBT_Q2_obs1 = new TProfile2D("Parity_e_noHBT_Q2_obs1","Parity_e_noHBT_Q2_obs1",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pParity_e_noHBT_Q2_obs2 = new TProfile2D("Parity_e_noHBT_Q2_obs2","Parity_e_noHBT_Q2_obs2",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pParity_w_noHBT_Q2_obs1 = new TProfile2D("Parity_w_noHBT_Q2_obs1","Parity_w_noHBT_Q2_obs1",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pParity_w_noHBT_Q2_obs2 = new TProfile2D("Parity_w_noHBT_Q2_obs2","Parity_w_noHBT_Q2_obs2",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pDelta_noHBT_Q2_obs1 = new TProfile2D("pDelta_noHBT_Q2_obs1","pDelta_noHBT_Q2_obs1",4,0.5,4.5,500,0,50, -100,100,"");
        TProfile2D *pDelta_noHBT_Q2_obs2 = new TProfile2D("pDelta_noHBT_Q2_obs2","pDelta_noHBT_Q2_obs2",4,0.5,4.5,500,0,50, -100,100,"");

//defining variables
float pVx, pVy, pVz, VPDvz, BBCco, ZDCcoin, net_Nch_Asym, mQx, mQy;                   //run, event info
int   Run, Day, Day2, Day3, Trigger, RefMult, TOFMult, Ntofmatch, Centrality, NPTracks, Fcount, Fcount_parent, Scount, POIcount;   //
...
float v2=0, v2e=0, v2w=0, v2_sub=0, v2_EPD1 = 0, v2_EPDe=0,v2_EPDw=0, v2_BBCe=0,v2_BBCw=0, v2_ZDC=0,v2_parent=0, v2_parent_e=0, v2_parent_w=0;
float Rsin = 0, Rcos = 0;
int iCh = 0;
...
void MakeTPC_EP(StPicoDst *d, int *iTr, int cen);			//reconstruct TPC EPs
...
void Gamma_TPC(int cen=1, int opt_weight =1, const Char_t *inFile = "test.list"){	//main_function
	delete gRandom;
	gRandom = new TRandom(0);

	DefineHistogram();
        char fname_old[200], fname_new[200];
        sprintf(fname_new,"cen%d.weight_1%d%d_TPC_new.root",cen,nHar-1,nHar);
        sprintf(fname_old,"cen%d.weight_1%d%d_TPC.root",cen,nHar-1,nHar);
...
//////////Real analysis begins here//////////////////////////////////////////////////////////////////////////////////////
	  	...
	  	Fcount = 0;
	  	int Qcount_parent = 0;
		mQQx_parent = 0.,mQQy_parent = 0. ,Q2_parent = 0.;
		...
		for(int trki = 0; trki < NPTracks; trki++){
			...
			if(DCAGlobal<1 && fabs(Eta)<0.9 && ndEdx>=15) {
				float p_i = Pt*cosh(Eta);
				nSigma_pi = picoTrack->nSigmaPion();
				Hist_nSigma_pi->Fill(p_i,nSigma_pi);
				if(picoTrack->isTofTrack()) {
					StPicoBTofPidTraits *trait = dst->btofPidTraits( picoTrack->bTofPidTraitsIndex() );
					if(trait && trait->btof()>0 && fabs(trait->btofYLocal())<1.8) {
						float beta_i = trait->btofBeta();
						if(beta_i!=0) {	
							float mass2_i = p_i*p_i*(1.0/beta_i/beta_i - 1.0);
							if(mass2_i>-0.01 && mass2_i<0.1) Hist_nSigma_pi_TOF->Fill(p_i,nSigma_pi);
						}
					}
				} 
			}
			...
			if(opt_useEPD==1) v2_sub = (cos(nHar*Phi_new[trki] - nHar*EPD_EP_east_new)+cos(nHar*Phi_new[trki] - nHar*EPD_EP_west_new))*50;
                        if(opt_useEPD==11)v2_sub = (cos(2*Phi_new[trki] - EPD_EP1_east_new - EPD_EP1_west_new))*100;
			...
			if(opt_useEPD==1) {
				...
				Rcos = 0.5*(sin(0.5*nHar*(Phi_new[trki] - EPD_EP_east_new - PI/nHar)) + sin(0.5*nHar*(Phi_new[trki] - EPD_EP_west_new - PI/nHar)));
                        ...
                        if(opt_useEPD==11) {
                                Rsin = 0.5*(sin(0.5*nHar*(Phi_new[trki] - EPD_EP1_east_new)) + sin(0.5*nHar*(Phi_new[trki] - EPD_EP1_west_new)));
                                Rcos = 0.5*(sin(0.5*nHar*(Phi_new[trki] - EPD_EP1_east_new - PI/nHar)) + sin(0.5*nHar*(Phi_new[trki] - EPD_EP1_west_new - PI/nHar)));
                        }
                        if(opt_useEPD==2) {
			...
			for(int trkj = trki+1; trkj < NPTracks; trkj++) {
				...
				float Phi1_new = Phi_new[trki];
                                ...
                                TLorentzVector lA; lA.SetPxPyPzE(Pt *cos(Phi1_new),Pt *sin(Phi1_new),Pt *sinh(Eta), sqrt(mpi*mpi+Pt*Pt*cosh(Eta)*cosh(Eta)));
                                TLorentzVector lB; lB.SetPxPyPzE(Pt2*cos(Phi2_new),Pt2*sin(Phi2_new),Pt2*sinh(Eta2),sqrt(mpi*mpi+Pt2*Pt2*cosh(Eta2)*cosh(Eta2)));
                                double pairInvMass = (lA+lB).M();
/*                                TVector3 boost = -(lA +lB).BoostVector();
                                lA.Boost(boost);
                                lB.Boost(boost);
                                if(opt_boost) {Phi1_new = lA.Phi(); Phi2_new = lB.Phi();}
*/
                                float phi_parent = (lA+lB).Phi();
				v2_parent_e = cos(nHar*phi_parent - nHar*TPC_EP_for_new)*100;
				v2_parent_w = cos(nHar*phi_parent - nHar*TPC_EP_bac_new)*100;	
				v2_parent = cos(nHar*phi_parent - nHar*psi_F2_new)*100;
				Hist_v2_v2parent_1->Fill(v2_parent,v2);
				float eta_parent = (lA+lB).Eta();
				float pt_parent  = (lA+lB).Pt();
				Hist_v2parent_eta_obs5->Fill(eta_parent, v2_parent, Eweight/eff);
				Hist_v2parent_pt_obs5->Fill(pt_parent, v2_parent, Eweight);
				if((opt_useEPD==0 && fabs(Eta)<Eta_ESE_Cut && fabs(Eta2)<Eta_ESE_Cut) || opt_useEPD>0) {
					mQQx_parent += cos(phi_parent*nHar);
					mQQy_parent += sin(phi_parent*nHar);
					Qcount_parent++;	

					Hist_v2_v2parent_2->Fill(0.5*(v2_parent_e+v2_parent_w),0.5*(v2e+v2w));
					Hist_parentv2->Fill(0.5*(v2_parent_e+v2_parent_w));
					Hist_v2parent_eta_obs6->Fill(eta_parent, 0.5*(v2_parent_e+v2_parent_w), Eweight/eff);
					Hist_v2parent_pt_obs6->Fill(pt_parent, 0.5*(v2_parent_e+v2_parent_w), Eweight);
					pTemp_v2_parent->Fill(1,v2_parent_e, 1./eff);pTemp_v2_parent->Fill(2,v2_parent_w, 1./eff);
					ppv2_parent_CosFW->Fill(0.5*(v2_parent_e+v2_parent_w),cos(nHar* TPC_EP_for_new- nHar*TPC_EP_bac_new),Eweight/eff);
					}
                                if(fabs(Pt-Pt2)>0.15 && fabs(Eta-Eta2)>0.15) {
					Hist_v2parent_eta_obs9->Fill(eta_parent, v2_parent, Eweight/eff);
					if((opt_useEPD==0 && fabs(Eta)<Eta_ESE_Cut && fabs(Eta2)<Eta_ESE_Cut) || opt_useEPD>0) {
						Hist_v2parent_eta_obs10->Fill(eta_parent, 0.5*(v2_parent_e+v2_parent_w), Eweight/eff);
						pTemp_v2_parent->Fill(3,v2_parent_e, 1./eff);pTemp_v2_parent->Fill(4,v2_parent_w, 1./eff);
						}
					}
				//correlations
				if(opt_useEPD==1) {TPC_EP_for_new = EPD_EP_west_new; TPC_EP_bac_new = EPD_EP_east_new;}
				if(opt_useEPD==2) {TPC_EP_for_new = BBC_EP_west_new; TPC_EP_bac_new = BBC_EP_east_new;}
				...
				if(opt_HighOrder==1) {
                                ...
                                if(opt_HighOrder==2) {
                                        correlator0 = cos(4*Phi - 2*Phi2 - 2*psi_F2_new)*100;
					correlator3 = cos(2*Phi1_new - 2*Phi2_new)*100;
                                        correlator4e= cos(4*Phi1_new - 2*Phi2_new - 2*TPC_EP_for_new)*100;
                                        correlator4w= cos(4*Phi1_new - 2*Phi2_new - 2*TPC_EP_bac_new)*100;
                                        correlator4 = cos(4*Phi1_new - 2*Phi2_new - 2*psi_F2_new)*100;
				} 
				if(opt_useEPD==1 || opt_useEPD==2) correlator4 = 0.5*(correlator4e+correlator4w);
				if(opt_useEPD==11) correlator4 = cos(Phi1_new + Phi2_new - EPD_EP1_east_new - EPD_EP1_west_new)*100;
				if(opt_useEPD==11 && opt_HighOrder==1) correlator4 = cos(Phi1_new -3*Phi2_new + EPD_EP1_east_new + EPD_EP1_west_new)*100;
                                if(opt_useEPD==11 && opt_HighOrder==2) correlator4 = cos(4*Phi1_new - 2*Phi2_new - EPD_EP1_east_new - EPD_EP1_west_new)*100;
				if(opt_useEPD==11) {correlator4e = correlator4; correlator4w = correlator4;}				
                                ...
                                if(Charge*Charge2>0) {
                                        Hist_InvMass_SS->Fill(pairInvMass);
                                        pParity_InvMass_SS->Fill(pairInvMass,correlator4);
				}
                                if(Charge*Charge2<0) {
                                        Hist_InvMass_OS->Fill(pairInvMass);
                                        pParity_InvMass_OS->Fill(pairInvMass,correlator4);
                                }
                                if(fabs(Pt-Pt2)>0.15 && fabs(Eta-Eta2)>0.15) {
...
//		Q2_parent = (mQQx_parent*mQQx_parent+mQQy_parent*mQQy_parent)/float(Qcount_parent);
		Q2_parent = (mQQx_parent*mQQx_parent+mQQy_parent*mQQy_parent)/float(Qcount_parent + Qcount_parent*Qcount_parent*v2_parent_averaged[cen-1]*v2_parent_averaged[cen-1]);
		Hist_Q2_parent->Fill(Q2_parent);
		Hist_RefMult_Q2_parent->Fill(Q2_parent,Fcount_parent);
		p_cos_Q2_parent->Fill(Q2_parent,cos(nHar* TPC_EP_for_new- nHar*TPC_EP_bac_new), Eweight);
		...
		v2_TPC_Day3->Fill(Day3, pTemp_v2->GetBinContent(7));
                ...
                v2_EPD1_Day3->Fill(Day3, pTemp_v2->GetBinContent(11));
...
/////////////////////////////////////////////
void MakeTPC_EP(StPicoDst *d, int *iTr , int cen) {
	  ...
	  if(mQx3==0 || mQy3==0) TPC_EP_for = -10;
          ...
          Q2 = (mQQx*mQQx+mQQy*mQQy)/float(Qcount + Qcount*Qcount*v2_averaged[cen-1]*v2_averaged[cen-1]);
...
void FillEP_resolution() {
	  ...
	  if(opt_useEPD==2) cos_fb = cos(nHar*BBC_EP_east_new-nHar*BBC_EP_west_new);
          if(opt_useEPD==11)cos_fb = cos(EPD_EP1_east_new-EPD_EP1_west_new);
	  Fcount_parent = Fcount; 
          p_cos_Q2->Fill(Q2,cos_fb, Eweight);
          p_RefMult_Q2->Fill(Q2,Fcount);
          Hist_RefMult_Q2->Fill(Q2,Fcount_parent);
          if(net_Nch_Asym>-99) {
...
bool IsGoodPOI(StPicoTrack *p) {
	int nHF = p->nHitsFit();
        ...
        int nHM = p->nHitsMax();
	Hist_FMRatio->Fill(nHF/float(nHM));
...
void Fillv2() {
                        ...
                        if((opt_useEPD==0 && fabs(Eta)<Eta_ESE_Cut) || opt_useEPD>0) {
                        ...
                        pTemp_v2->Fill(11,v2_EPD1,1./eff);
}
//////////////////////////////////////////////////
void FillRcorr() {
	if(Charge>0) { pTemp_origin_obs->Fill(1,Rsin); pTemp_origin_obs->Fill(3,Rcos); }
	else { pTemp_origin_obs->Fill(2,Rsin); pTemp_origin_obs->Fill(4,Rcos); }
	if(iCh>0) { pTemp_shuffle_obs->Fill(1,Rsin); pTemp_shuffle_obs->Fill(3,Rcos); }
	else { pTemp_shuffle_obs->Fill(2,Rsin); pTemp_shuffle_obs->Fill(4,Rcos); }
...
void WrapUpESE() {
	...
	if(opt_useEPD==11) {Temp_v2e = pTemp_v2->GetBinContent(11); Temp_v2w = pTemp_v2->GetBinContent(11);}
	...
	Temp_parity3e = pTemp_parity_e->GetBinContent(3);
        Temp_parity4e = pTemp_parity_e->GetBinContent(4);
        Temp_parity3w = pTemp_parity_w->GetBinContent(3);
        Temp_parity4w = pTemp_parity_w->GetBinContent(4);
        if((Temp_v2e!=0) && (Temp_parity3e!=0)) {p_Parity_v2e_parent_obs1->Fill(Temp_v2e,Temp_parity3e); p_Parity_v2e_parent_obs2->Fill(Temp_v2e,Temp_parity3e, Eweight);}
        if((Temp_v2e!=0) && (Temp_parity4e!=0)) {p_Parity_v2e_parent_obs3->Fill(Temp_v2e,Temp_parity4e); p_Parity_v2e_parent_obs4->Fill(Temp_v2e,Temp_parity4e, Eweight);}
        if((Temp_v2w!=0) && (Temp_parity3w!=0)) {p_Parity_v2w_parent_obs1->Fill(Temp_v2w,Temp_parity3w); p_Parity_v2w_parent_obs2->Fill(Temp_v2w,Temp_parity3w, Eweight);}
        if((Temp_v2w!=0) && (Temp_parity4w!=0)) {p_Parity_v2w_parent_obs3->Fill(Temp_v2w,Temp_parity4w); p_Parity_v2w_parent_obs4->Fill(Temp_v2w,Temp_parity4w, Eweight);}
	if( (Temp_v2e!=0) && (Temp_v2w!=0)) {Hist_parentv2_event->Fill(0.5*(Temp_v2e+Temp_v2w));pv2parent_CosFW->Fill(0.5*(Temp_v2e+Temp_v2w),cos(nHar* TPC_EP_for_new- nHar*TPC_EP_bac_new),Eweight/eff);}
	float Temp_v2d_e = pTemp_v2->GetBinContent(1);
	float Temp_v2d_w = pTemp_v2->GetBinContent(2);
	if((Temp_v2e!=0) && (Temp_v2w!=0) && (Temp_v2d_e!=0) && (Temp_v2d_w!=0)){Hist_v2_v2parent_3->Fill(0.5*(Temp_v2e+Temp_v2w),0.5*(Temp_v2d_e+Temp_v2d_w));}

        if(Temp_v2e!=0) {p_v2parente_Q2parent_obs1->Fill(Q2_parent,Temp_v2e); p_v2parente_Q2parent_obs2->Fill(Q2_parent,Temp_v2e, Eweight);}
        if(Temp_v2w!=0) {p_v2parentw_Q2parent_obs1->Fill(Q2_parent,Temp_v2w); p_v2parentw_Q2parent_obs2->Fill(Q2_parent,Temp_v2w, Eweight);}
        if(Temp_parity3e!=0) {pParity_e_Q2parent_obs1->Fill(3, Q2_parent, Temp_parity3e);pParity_e_Q2parent_obs2->Fill(3, Q2_parent, Temp_parity3e, Eweight);}
        if(Temp_parity4e!=0) {pParity_e_Q2parent_obs1->Fill(4, Q2_parent, Temp_parity4e);pParity_e_Q2parent_obs2->Fill(4, Q2_parent, Temp_parity4e, Eweight);}
        if(Temp_parity3w!=0) {pParity_w_Q2parent_obs1->Fill(3, Q2_parent, Temp_parity3w);pParity_w_Q2parent_obs2->Fill(3, Q2_parent, Temp_parity3w, Eweight);}
        if(Temp_parity4w!=0) {pParity_w_Q2parent_obs1->Fill(4, Q2_parent, Temp_parity4w);pParity_w_Q2parent_obs2->Fill(4, Q2_parent, Temp_parity4w, Eweight);}


        Temp_v2e = pTemp_v2_parent->GetBinContent(3);
        Temp_v2w = pTemp_v2_parent->GetBinContent(4);
        Temp_parity3e = pTemp_parity_e_noHBT->GetBinContent(3);
        Temp_parity4e = pTemp_parity_e_noHBT->GetBinContent(4);
        Temp_parity3w = pTemp_parity_w_noHBT->GetBinContent(3);
        Temp_parity4w = pTemp_parity_w_noHBT->GetBinContent(4);
        if((Temp_v2e!=0) && (Temp_parity3e!=0)) {p_Parity_v2e_parent_noHBT_obs1->Fill(Temp_v2e,Temp_parity3e); p_Parity_v2e_parent_noHBT_obs2->Fill(Temp_v2e,Temp_parity3e, Eweight);}
        if((Temp_v2e!=0) && (Temp_parity4e!=0)) {p_Parity_v2e_parent_noHBT_obs3->Fill(Temp_v2e,Temp_parity4e); p_Parity_v2e_parent_noHBT_obs4->Fill(Temp_v2e,Temp_parity4e, Eweight);}
        if((Temp_v2w!=0) && (Temp_parity3w!=0)) {p_Parity_v2w_parent_noHBT_obs1->Fill(Temp_v2w,Temp_parity3w); p_Parity_v2w_parent_noHBT_obs2->Fill(Temp_v2w,Temp_parity3w, Eweight);}
        if((Temp_v2w!=0) && (Temp_parity4w!=0)) {p_Parity_v2w_parent_noHBT_obs3->Fill(Temp_v2w,Temp_parity4w); p_Parity_v2w_parent_noHBT_obs4->Fill(Temp_v2w,Temp_parity4w, Eweight);}
        if(Temp_v2e!=0) {p_v2parente_Q2parent_noHBT_obs1->Fill(Q2_parent,Temp_v2e); p_v2parente_Q2parent_noHBT_obs2->Fill(Q2_parent,Temp_v2e, Eweight);}
        if(Temp_v2w!=0) {p_v2parentw_Q2parent_noHBT_obs1->Fill(Q2_parent,Temp_v2w); p_v2parentw_Q2parent_noHBT_obs2->Fill(Q2_parent,Temp_v2w, Eweight);}
        if(Temp_parity3e!=0) {pParity_e_Q2parent_noHBT_obs1->Fill(3, Q2_parent, Temp_parity3e);pParity_e_Q2parent_noHBT_obs2->Fill(3, Q2_parent, Temp_parity3e, Eweight);}
        if(Temp_parity4e!=0) {pParity_e_Q2parent_noHBT_obs1->Fill(4, Q2_parent, Temp_parity4e);pParity_e_Q2parent_noHBT_obs2->Fill(4, Q2_parent, Temp_parity4e, Eweight);}
        if(Temp_parity3w!=0) {pParity_w_Q2parent_noHBT_obs1->Fill(3, Q2_parent, Temp_parity3w);pParity_w_Q2parent_noHBT_obs2->Fill(3, Q2_parent, Temp_parity3w, Eweight);}
        if(Temp_parity4w!=0) {pParity_w_Q2parent_noHBT_obs1->Fill(4, Q2_parent, Temp_parity4w);pParity_w_Q2parent_noHBT_obs2->Fill(4, Q2_parent, Temp_parity4w, Eweight);}
